        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="col-span-3 flex flex-col gap-4">
                    ...
                    <FormItem className="flex items-center space-x-1 space-y-0">
                      ...
                      <div className="relative group">   
                        <Checkbox
                          ...
                          className="h-5 w-5 absolute -left-1 -top-1 z-10 opacity-0"
                          checked={field.value.some((val) => val.id === pel.id)}
                          onCheckedChange={(checked) => {
                            return checked ?
                              field.onChange(field.value?.filter((value) => value.id !== pel.id)) 
              ...
              <Input placeholder="Menjadi Insan manusia yang berakhlak mulia" onChange={(e) => setInputPelajari(e.target.value)} defaultValue="Menjadi insan manusia yang berakhlak mulia"/>
                                        ...
                                        <Checkbox
                                          ...
                                          onCheckedChange={(checked) => {
                                            return checked
                                              ...
                                              : field.onChange([...field.value, item.id.toString()]); // kalo ga di klik data masuk
                                          }}
                                        />
