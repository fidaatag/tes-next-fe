      ...
      <div>
        <Tabs defaultValue="diulas" className="">
          <TabsList>
            <TabsTrigger
              value="diulas"
              onClick={() => setStatusKelas("diulas")}
            >
              Perlu Diulas
            </TabsTrigger>
            <TabsTrigger
              value="public"
              onClick={() => setStatusKelas("public")}
            >
              Public
            </TabsTrigger>
            <TabsTrigger value="draf" onClick={() => setStatusKelas("draf")}>
              Draf
            </TabsTrigger>
            <TabsTrigger value="semua" onClick={() => setStatusKelas("semua")}>
              Semua
            </TabsTrigger>
          </TabsList>
